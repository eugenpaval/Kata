...
{
    [TestFixture]
    public class PyramidSlideTests
    {
        [Test]
        public void SmallPyramidTest()
        {
            ...
            Assert.AreEqual(23, PyramidSlide.LongestSlideDown(smallPyramid));
        }
        ...
        public void MediumPyramidTest()
        {
            ...
            Assert.AreEqual(1074, PyramidSlide.LongestSlideDown(mediumPyramid));
        }
    }
}
